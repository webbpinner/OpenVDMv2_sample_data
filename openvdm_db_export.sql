...
INSERT INTO `OVDM_CollectionSystemTransfers` VALUES (1,'OpenRVDAS','OpenRVDAS (SSH Server)',0,'/vault/sample_data/OpenRVDAS','OpenRVDAS',0,0,4,0,'','','','','','','','127.0.0.1','root',1,NULL,'*','','',2,1,0,0),(2,'XBT','XBT  (Authenticated SMB Share)',0,'XBT','XBT',0,0,3,0,'','','','//localhost/SampleAuthSource','survey','Tethys337813','WORKGROUP','','',0,'','*{cruiseID}_XBT[0-9][0-9][0-9]_*','','',2,1,0,0),(3,'EM302','EM302 Multibeam (Rsync Server)',0,'/EM302','EM302',0,0,2,0,'localhost/sample_data','survey','badPassword!','','','','','','',0,'','*','','',2,1,0,0),(4,'CTD','SBE 911+ CTD (Local Directory)',0,'/vault/sample_data/CTD','CTD ',0,0,1,0,'','','','','','','','','',0,'','*{cruiseID}_CTD[0-9][0-9][0-9]_*','','*decktest*',2,1,0,0),(5,'Sealog','Sealog (Guest SMB Share)',0,'sealog','Sealog',0,0,3,0,'','','','//localhost/SampleAnonSource','guest','','WORKGROUP','','',0,'','*','','',2,1,0,0),(7,'ROV_SCS','SCS collecting data for ROV',1,'/vault/sample_data/rov/SCSData','SCSData',0,0,1,0,'','','','','','','','','',0,'','*','','',2,1,0,0);
...
INSERT INTO `OVDM_CruiseDataTransfers` VALUES (1,'SSDW','Shoreside Data Warehouse',4,'/vault/sample_data/ssdw',0,'','','','','','','','localhost','survey',1,NULL,2,1,1,0,128,0,0,'0','0'),(2,'Local_Copy','Cruise copy to local directory',1,'/vault/sample_data/local_destination',0,'','','','','','','','','',0,'',2,1,0,0,0,0,0,'0','0'),(3,'Cruise_Auth_SMB','Cruise copy to authenticated SMB share',3,'/',0,'','','','//localhost/SampleAuthDestination','survey','Tethys337813','WORKGROUP','','',0,'',2,1,0,0,0,0,0,'0','0'),(4,'Cruise_Anon_SMB','Cruise copy to anonymous SMB share',3,'/',0,'','','','//localhost/SampleAnonDestination','guest','','WORKGROUP','','',0,'',2,1,0,0,0,0,0,'0','0'),(5,'cruise_rsync','Cruise copy to rsync server',2,'/',0,'localhost/sample_dest','survey','badPassword!','','','','','','',0,'',2,1,0,0,0,0,0,'0','0'),(6,'cruise_ssh','Cruise copy to SSH server',4,'/vault/sample_data/ssh_destination',0,'','','','','','','','localhost','survey',1,NULL,2,1,0,0,0,0,0,'0','0');
